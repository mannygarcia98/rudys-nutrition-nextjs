  ...
  return (
    <>
      ...
      <>
        ...
        {/* Nav */}
        {/* Hero */}
        public/images/stretched-straightened-blue-shoes-weights-2560.jpeg
        <section className="bg-center bg-repeat bg-[url('/images/straightened-blue-shoes-weights-1920.png')] bg-gray-500 bg-blend-multiply">
          <div className="px-4 mx-auto max-w-screen-xl text-center mt-9 py-auto lg:pt-72 lg:pb-56">
